...
var default_alipay_config = {
	...
	,key:'i3eg954b5z0oz9xlz41c1d0dm7zakzuw'//安全检验码，以数字和字母组成的32位字符
	,seller_email:'22668611@qq.com' //卖家支付宝帐户 必填
...
Alipay.prototype.buildRequestPara = function(data){
    //建立请求
    var alipaySubmit = new AlipaySubmit(this.alipay_config);
    return alipaySubmit.buildRequestPara(data);
};
Alipay.prototype.buildRequestParaToString = function(data){
    //建立请求
    var alipaySubmit = new AlipaySubmit(this.alipay_config);
    return alipaySubmit.buildRequestParaToString(data);
};
Alipay.prototype.buildRequestForm = function(data){
    //建立请求
    var alipaySubmit = new AlipaySubmit(this.alipay_config);
    return alipaySubmit.buildRequestForm(data,'post','comfirm');
};

Alipay.prototype.notifyVerify = function(data,callback){
    var alipaySubmit = new AlipaySubmit(this.alipay_config);
    alipaySubmit.httpGet(data,callback);
}
