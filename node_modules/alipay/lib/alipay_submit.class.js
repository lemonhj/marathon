...
AlipaySubmit.prototype.buildRequestForm = function (para_temp, method, button_name) {
    ...
    var sHtml = "<form id='alipaysubmit' name='alipaysubmit' action='"
            ...
            +  "_input_charset="
            + this.alipay_config['_input_charset'].toLowerCase().trim()
            + "' method='" + method + "'>";
...
AlipaySubmit.prototype.httpGet = function(data,callback){
    var url = this.alipay_gateway_new + core_funcs.createLinkstringUrlencode(data);
    core_funcs.httpGet(url,callback);
}
